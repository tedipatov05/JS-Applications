...
import { getItemById, updateById } from '../src/api/data.js';    
...
export async function editView(ctx) {
    ...
    ctx.render(createFormTemplate(item));
...
async function onSubmit(e){
    ...
    const res = await updateById(id, {make, model, year, description, price, img, material});

    context.page.redirect('/');
}

function createFormTemplate(item) {
    return html`
